...
Author: Developer IDS
Version: 1.0
*/

class contactCustomization{
  ...
  public function admin_bike_menu_page() {
      add_menu_page(
          ...
          'manage-contact',                      // Slug
          array( $this, 'contact' ),             // Calling contact Function here
          'dashicons-email-alt',                 // Used For Icon
          5
      );
      ...
      add_submenu_page(                    
          'manage-contact',                      // url
          'Add New',                             // title name
          'Add New',                             // shortcode reference
          'manage_options',                      // Capability (who can use this option)
          'manage-add_new',                      // slug (unique of key)
          array( $this, 'add_new' )              // function(call back)
      );
  }
