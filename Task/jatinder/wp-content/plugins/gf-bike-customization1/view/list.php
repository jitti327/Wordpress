  ...
  function custom_record(){
    ...
    */
    ...
    function renderView(){
      ...
      echo $message;
      $page = $_REQUEST['page'];
      $queryString = "page=$page&success=insert";
      $queryString1 = "page=$page&success=updated";
      $inserturl = admin_url( 'admin.php?'.$queryString );
      $updateurl = admin_url( 'admin.php?'.$queryString1 );
      if($inserturl){
        echo $this->requiredMessage("updated","Record Deleted Successfully");
      }
      ...
      <div class="wrap">        
        <div id="icon-users" class="icon32"><br/></div>
          ...
          <a href="<?php echo admin_url('admin.php?page='.$page,'admin'); ?>&action=add" class="page-title-action">Add New</a>
          <!-- Forms are NOT created automatically, so you need to wrap the table in one to use features like bulk actions -->
        <form id="movies-filter" method="POST" action="">
            <!-- For plugins, we also need to ensure that the form posts back to our current page -->
            <input type="hidden" name="page" value="<?php echo $page; ?>" />
            <!-- Now we can render the completed list table -->
            <?php $this->search_box('search','locate'); ?>
        </form>
